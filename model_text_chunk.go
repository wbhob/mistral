...
// checks if the TextChunk type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TextChunk{}
...
func NewNullableTextChunk(val *TextChunk) *NullableTextChunk {
	return &NullableTextChunk{value: val, isSet: true}
}

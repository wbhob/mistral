...
// checks if the UpdateFTModelIn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateFTModelIn{}
...
type NullableUpdateFTModelIn struct {
	value *UpdateFTModelIn
	isSet bool
}

func (v NullableUpdateFTModelIn) Get() *UpdateFTModelIn {
	return v.value
}

func (v *NullableUpdateFTModelIn) Set(val *UpdateFTModelIn) {
	v.value = val
	v.isSet = true
}
...
func NewNullableUpdateFTModelIn(val *UpdateFTModelIn) *NullableUpdateFTModelIn {
	return &NullableUpdateFTModelIn{value: val, isSet: true}
}

...
// checks if the TrainingParametersIn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrainingParametersIn{}

// TrainingParametersIn The fine-tuning hyperparameter settings used in a fine-tune job.
type TrainingParametersIn struct {
...
func (o *TrainingParametersIn) SetTrainingStepsNil() {
...
func (o *TrainingParametersIn) SetWeightDecayNil() {
...
func (o *TrainingParametersIn) SetWarmupFractionNil() {
...
func (o *TrainingParametersIn) SetEpochsNil() {
	o.Epochs.Set(nil)
}
...
func (o *TrainingParametersIn) SetFimRatioNil() {
	o.FimRatio.Set(nil)
}
...
func (o *TrainingParametersIn) SetSeqLenNil() {
	o.SeqLen.Set(nil)
}
...
func (o TrainingParametersIn) MarshalJSON() ([]byte, error) {
...
func (o TrainingParametersIn) ToMap() (map[string]interface{}, error) {
...
type NullableTrainingParametersIn struct {
	value *TrainingParametersIn
	isSet bool
}

func (v NullableTrainingParametersIn) Get() *TrainingParametersIn {
	return v.value
}

func (v *NullableTrainingParametersIn) Set(val *TrainingParametersIn) {
	v.value = val
	v.isSet = true
}

func (v NullableTrainingParametersIn) IsSet() bool {
	return v.isSet
}

func (v *NullableTrainingParametersIn) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrainingParametersIn(val *TrainingParametersIn) *NullableTrainingParametersIn {
	return &NullableTrainingParametersIn{value: val, isSet: true}
}

func (v NullableTrainingParametersIn) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrainingParametersIn) UnmarshalJSON(src []byte) error {
	v.isSet = true

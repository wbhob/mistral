...
// checks if the CompletionDetailedJobOut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CompletionDetailedJobOut{}
...
type _CompletionDetailedJobOut CompletionDetailedJobOut
...
func (o *CompletionDetailedJobOut) UnmarshalJSON(data []byte) (err error) {
	...
	varCompletionDetailedJobOut := _CompletionDetailedJobOut{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCompletionDetailedJobOut)

	if err != nil {
		return err
	}

	*o = CompletionDetailedJobOut(varCompletionDetailedJobOut)

	return err
}

type NullableCompletionDetailedJobOut struct {
	value *CompletionDetailedJobOut
	isSet bool
}

func (v NullableCompletionDetailedJobOut) Get() *CompletionDetailedJobOut {
	return v.value
}

func (v *NullableCompletionDetailedJobOut) Set(val *CompletionDetailedJobOut) {
	v.value = val
	v.isSet = true
}

func (v NullableCompletionDetailedJobOut) IsSet() bool {
	return v.isSet
}

func (v *NullableCompletionDetailedJobOut) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompletionDetailedJobOut(val *CompletionDetailedJobOut) *NullableCompletionDetailedJobOut {
	return &NullableCompletionDetailedJobOut{value: val, isSet: true}
}

...
// checks if the ClassifierTrainingParametersIn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClassifierTrainingParametersIn{}
...
func NewClassifierTrainingParametersIn() *ClassifierTrainingParametersIn {
	this := ClassifierTrainingParametersIn{}
...
type NullableClassifierTrainingParametersIn struct {
	value *ClassifierTrainingParametersIn
	isSet bool
}

func (v NullableClassifierTrainingParametersIn) Get() *ClassifierTrainingParametersIn {
	return v.value
}

func (v *NullableClassifierTrainingParametersIn) Set(val *ClassifierTrainingParametersIn) {
	v.value = val
	v.isSet = true
}

func (v NullableClassifierTrainingParametersIn) IsSet() bool {
	return v.isSet
}

func (v *NullableClassifierTrainingParametersIn) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClassifierTrainingParametersIn(val *ClassifierTrainingParametersIn) *NullableClassifierTrainingParametersIn {
	return &NullableClassifierTrainingParametersIn{value: val, isSet: true}
}

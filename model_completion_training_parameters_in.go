...
// checks if the CompletionTrainingParametersIn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CompletionTrainingParametersIn{}
...
type NullableCompletionTrainingParametersIn struct {
	value *CompletionTrainingParametersIn
	isSet bool
}

func (v NullableCompletionTrainingParametersIn) Get() *CompletionTrainingParametersIn {
	return v.value
}

func (v *NullableCompletionTrainingParametersIn) Set(val *CompletionTrainingParametersIn) {
	v.value = val
	v.isSet = true
}

func (v NullableCompletionTrainingParametersIn) IsSet() bool {
	return v.isSet
}

func (v *NullableCompletionTrainingParametersIn) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompletionTrainingParametersIn(val *CompletionTrainingParametersIn) *NullableCompletionTrainingParametersIn {
	return &NullableCompletionTrainingParametersIn{value: val, isSet: true}
}
